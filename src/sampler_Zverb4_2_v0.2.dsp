...
f1=500;
//[accy:-1 0 5 0]
  t60dc = hslider("v:sfPlayer parameter(s)/[2] Low RT60 [acc:1 1 -10 10 0 5][color:255 255 0][hidden:1]", 2, 1, 7, 0.1);
//[accy:-1 0 5 0]
  t60m = hslider("v:sfPlayer parameter(s)/[3] Mid RT60 [acc:1 1 -10 10 0 5][color:255 255 0][hidden:1]", 3, 1, 7, 0.1);
...
//[accy:-1. 0. 5. 0]
  drywet =(hslider("v:sfPlayer parameter(s)/[1] Dry/Wet Mix  [tooltip: -1 = dry, 1 = wet] [acc:1 1 -10 10 0 5][color:255 255 0][hidden:1]", 0, 0, 17, 0.1)*0.02)-1:lowpass(1,1):max(-1):min(1);
